...
- **Token usage** - cumulative session shutdown snapshots are converted into per-resume intervals; OTel chat spans are preferred within the OTel source, with inference logs and agent-turn logs used as fallbacks.
